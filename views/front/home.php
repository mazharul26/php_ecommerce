            ...
            <div id="hero">
                <div id="owl-main" class="owl-carousel owl-inner-nav owl-ui-sm">
                    ...
                    <div class="item" style="background-image: url(assets/images/sliders/slider05.jpg);">
                        <div class="container-fluid">
                            <div class="caption vertical-center text-left">
                                <div class="big-text fadeInDown-1" style="color: #843534">
                                ...
                                <div class="button-holder fadeInDown-3">
                                    <a href="index.php?f=single-product&id=<?php echo $value->id ?>" class="big le-button ">shop now</a>
                                </div>
                            </div><!-- /.caption -->
                        </div><!-- /.container-fluid -->
                    </div><!-- /.item -->
                    ...
                    <div class="item" style="background-image: url(assets/images/sliders/slider06.jpg);">
                        <div class="container-fluid">
                            <div class="caption vertical-center text-left" style="color: #F27A24">
                        ...
                        <div class="col-sm-4 col-md-3  no-margin product-item-holder hover">
                            <div class="product-item">
                                ...
                                <div class="body">
                                    ...
                                    <div class="title">
                                        <a href="index.php?f=single-product&id=<?php echo $value->id ?>">VAIO Fit Laptop - Windows 8 SVF14322CXW</a>
                                    </div>
                                ...
                                <div class="hover-area">
                                    <div class="add-cart-button">
                                        <a href="index.php?f=single-product&id=<?php echo $value->id ?>" class="le-button">add to cart</a>
                                    </div>
                        ...
                        <div class="col-sm-4 col-md-3 no-margin product-item-holder hover">
                            <div class="product-item">
                                ...
                                <div class="body">
                                    ...
                                    <div class="title">
                                        <a href="index.php?f=single-product&id=<?php echo $value->id ?>">White lumia 9001</a>
                                    </div>
                        ...
                        <div class="col-sm-4 col-md-3 no-margin product-item-holder hover">
                            <div class="product-item">
                                ...
                                <div class="body">
                                    <div class="label-discount clear"></div>
                                    <div class="title">
                                        <a href="index.php?f=single-product&id=<?php echo $value->id ?>">POV Action Cam</a>
                                    </div>
                                    <div class="brand">sony</div>
                                </div>
                                <div class="prices">
                        ...
                        <div class="col-sm-4 col-md-3 no-margin product-item-holder hover">
                            <div class="product-item">
                                ...
                                <div class="body">
                                    <div class="label-discount clear"></div>
                                    <div class="title">
                                        <a href="index.php?f=single-product&id=<?php echo $value->id ?>">Netbook Acer TravelMate
                                            B113-E-10072</a>
                                    </div>
                    ...
                    <div class="product-grid-holder">
                        ...
                        <div class="tab-pane active" id="featured">
                            <div class="product-grid-holder">
                                ...
                                while ($value = $products->fetch_object())
                                {
                                    ?>
                                    ...
                                    <div class="col-sm-4 col-md-3 no-margin product-item-holder hover">
                                        <div class="product-item">
                                            ...
                                            <div class="image">
                                                ...
                                                echo "<img class='image-responsive' src='" . $rooturl . resize(
                                                        'images/products/' . fileNameSecure($value->id) . '/' . $value->featuredImage, 'images/products/' . fileNameSecure($value->id) . '/' . 'f-246-186.' . $featured[1], 246, 186) . "' />";
                                                ?>
                                            </div>
                                            <div class="body">
                                                <div class="label-discount green">% sale</div>
                                                <div class="label-discount clear"></div>
                                                <div class="title">
                                                    <a href="index.php?f=single-product&id=<?php echo $value->id ?>"><?php echo $value->title; ?></a>
                                                </div>
                                                <div class="brand"><?php echo $value->category_name; ?></div>
                                            </div>
                                            <div class="prices">
                    ...
                    <div class="col-xs-12 col-sm-4 no-margin product-item-holder size-medium hover">
                        <div class="product-item">
                            ...
                            <div class="body">
                                <div class="label-discount clear"></div>
                                <div class="title">
                                    <a href="index.php?f=single-product&id=<?php echo $value->id ?>">beats studio headphones official one</a>
                                </div>
                    ...
                    <div class="col-xs-12 col-sm-4 no-margin product-item-holder size-medium hover">
                        <div class="product-item">
                            ...
                            <div class="body">
                                <div class="label-discount clear"></div>
                                <div class="title">
                                    <a href="index.php?f=single-product&id=<?php echo $value->id ?>">playstasion 4 with four games and pad</a>
                                </div>
                                <div class="brand">acer</div>
                            </div>
                            <div class="prices">
                    ...
                    <div class="col-xs-12 col-sm-4 no-margin product-item-holder size-medium hover">
                        <div class="product-item">
                            ...
                            <div class="body">
                                <div class="label-discount clear"></div>
                                <div class="title">id ?>}">
                                    <a href="index.php?f=single-product&id=<?php echo $value->id ?>">EOS rebel t5i DSLR Camera with 18-55mm IS STM lens</a>
                                </div>
                    ...
                    <div class="col-xs-12 col-sm-4 no-margin product-item-holder size-medium hover">
                        <div class="product-item">
                            ...
                            <div class="body">
                                <div class="label-discount clear"></div>
                                <div class="title">
                                    <a href="index.php?f=single-product&id=<?php echo $value->id ?>">fitbit zip wireless activity tracker - lime</a>
                                </div>
                    ...
                    <div class="col-xs-12 col-sm-4 no-margin product-item-holder size-medium hover">
                        <div class="product-item">
                            ...
                            <div class="body">
                                <div class="label-discount clear"></div>
                                <div class="title">
                                    <a href="index.php?f=single-product&id=<?php echo $value->id ?>">PowerShot elph 115 16MP digital camera</a>
                                </div>
                                <div class="brand">canon</div>
                            </div>
                            <div class="prices">
                    ...
                    <div class="col-xs-12 col-sm-4 no-margin product-item-holder size-medium hover">
                        <div class="product-item">
                            ...
                            <div class="body">
                                <div class="label-discount clear"></div>
                                <div class="title">
                                    <a href="index.php?f=single-product&id=<?php echo $value->id ?>">netbook acer travelMate b113-E-10072</a>
                                </div>
                                <div class="brand">acer</div>
                            </div>
                            <div class="prices">
            ...
            <div class="col-xs-12 col-md-5 no-margin">
                <div class="product-item-holder size-big single-product-gallery small-gallery">
                    ...
                    <div class="body">
                        <div class="label-discount clear"></div>
                        <div class="title">
                            <a href="index.php?f=single-product&id=<?php echo $value->id ?>">CPU intel core i5-4670k 3.4GHz BOX B82-12-122-41</a>
                        </div>
                        <div class="brand">sony</div>
                    </div>
            ...
            <div id="owl-recently-viewed" class="owl-carousel product-grid-holder">
                <div class="no-margin carousel-item product-item-holder size-small hover">
                    <div class="product-item">
                        ...
                        <div class="body">
                            <div class="title">
                                <a href="index.php?f=single-product&id=<?php echo $value->id ?>">LC-70UD1U 70" class aquos 4K ultra HD</a>
                            </div>
                ...
                <div class="no-margin carousel-item product-item-holder size-small hover">
                    <div class="product-item">
                        ...
                        <div class="body">
                            <div class="title">
                                <a href="index.php?f=single-product&id=<?php echo $value->id ?>">cinemizer OLED 3D virtual reality TV Video</a>
                            </div>
                ...
                <div class=" no-margin carousel-item product-item-holder size-small hover">
                    <div class="product-item">
                        ...
                        <div class="body">
                            <div class="title">
                                <a href="index.php?f=single-product&id=<?php echo $value->id ?>">s2340T23" full HD multi-Touch Monitor</a>
                            </div>
                ...
                <div class=" no-margin carousel-item product-item-holder size-small hover">
                    <div class="product-item">
                        ...
                        <div class="body">
                            <div class="title">
                                <a href="index.php?f=single-product&id=<?php echo $value->id ?>">kardon BDS 7772/120 integrated 3D</a>
                            </div>
                ...
                <div class=" no-margin carousel-item product-item-holder size-small hover">
                    <div class="product-item">
                        ...
                        <div class="body">
                            <div class="title">
                                <a href="index.php?f=single-product&id=<?php echo $value->id ?>">netbook acer travel B113-E-10072</a>
                            </div>
                            <div class="brand">acer</div>
                        </div>
                        <div class="prices">
                ...
                <div class=" no-margin carousel-item product-item-holder size-small hover">
                    <div class="product-item">
                        ...
                        <div class="body">
                            <div class="title">
                                <a href="index.php?f=single-product&id=<?php echo $value->id ?>">iPod touch 5th generation,64GB, blue</a>
                            </div>
