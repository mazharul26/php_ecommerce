        ...
        <div class="row">
            ...
            <div class="col-xs-12">
                <section class="section register inner-left-xs">
                    ...
                    {
                        if ($data->update('subcategory', ['subcategory_name' => $_POST['subcategory'], 'categoryid' => $_POST['category']],array("id"=>$_GET['id'])))
                        {
                            echo " <b>" . $_POST['subcategory'] . "</b> Update to Subcategories.";
                        }
                        else
                        {
//                            $data->Error;
