                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu" role="menu" >
                                    ...
                                    while ($row = $payMethods->fetch_object())
                                    {
                                        ...
                                        echo '<li role="presentation"><a role="menuitem" tabindex="-1" href="index.php?f=category-grid">' . $row->category_name . '</a></li>';
                                    }
                                    ?>
                                </ul>
            ...
            <div class="yamm navbar">
                ...
                <div class="collapse navbar-collapse" id="mc-horizontal-menu-collapse">
                    <ul class="nav navbar-nav">
                        <li class="dropdown">
                            <a href="index.php?f=shop1" class="dropdown-toggle" data-hover="dropdown">Shop</a>
